...
>
  ...
  :class="[
    'collapsed-input-block h-8 mx-2 mt-2 rounded-lg border border-primary flex items-center overflow-hidden transition-all duration-300 ease-in-out cursor-pointer select-none touch-manipulation',
